...
Don’t forget to register for our upcoming sessions at CNX!.

https://invite.salesforce.com/salesforceconnectionsmetaprese#g-108497786

Have a successful Connections and please stop by anytime to learn more about Meta and Salesforce partnership.`
          });
      ...
      if (
        ...
        try {
          await twilioClient.client.messages.create({
            from: FROM_NUMBER,
            to: user,
            body: `Thanks for stopping by the Meta booth! If you'd like to learn more about our partnership with Salesforce, please complete this form to get in touch. 
      ...
      if (
        ...
        try {
          const message = await twilioClient.client.messages.create({
            from: FROM_NUMBER,
            to: user,
            body: `Thank you for attending Connections and stopping by the Meta booth! 
            
Do you have a couple of minutes to answer some questions to help Meta improve our efforts to develop valuable content and experiences for businesses like yours. It's a quick survey and we really value your opinion.\n\nWe may use your data for personalization, innovation, research and other purposes described in our Privacy Policy:\nhttps://facebook.com/privacy/policy\n\nClick to launch the survey.\nhttps://www.facebook.com/survey/?config_id=1209904114213079`
          });
